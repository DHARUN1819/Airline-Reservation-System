...
<div id="flights">
						...
						<div>
                            ...
                            <select id="fclass" name="fclass" onchange="document.getElementById('selected_text4').value=this.options[this.selectedIndex].text">
										<option value="0" disabled="disabled" selected="selected" id="place1">Select Class</option>
					...
					<input type="hidden" name="selected_text3" id="selected_text4" value="" />
